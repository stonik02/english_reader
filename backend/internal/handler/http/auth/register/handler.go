...
func New(u UseCase, s bool, ttl time.Duration) *Handler { return &Handler{u, s, ttl} }
func (h *Handler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	response.Write(w, http.StatusCreated, map[string]any{"user": v.User, "access_token": v.AccessToken, "access_token_expires_at": v.AccessExpiresAt})
}
