...
// Source: internal/handler/http/reader/updatesettings/dependencies.go
//
// Generated by this command:
//
//	mockgen -source=internal/handler/http/reader/updatesettings/dependencies.go -destination=internal/handler/http/reader/updatesettings/mock_dependencies_test.go -package=updatesettings
//
...
func (m *MockUseCase) Execute(arg0 context.Context, arg1 string, arg2 reader.Settings) (reader.Settings, error) {
	m.ctrl.T.Helper()
