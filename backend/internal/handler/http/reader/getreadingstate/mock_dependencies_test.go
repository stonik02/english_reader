...
// Source: internal/handler/http/reader/getreadingstate/dependencies.go
//
// Generated by this command:
//
//	mockgen -source=internal/handler/http/reader/getreadingstate/dependencies.go -destination=internal/handler/http/reader/getreadingstate/mock_dependencies_test.go -package=getreadingstate
//
...
func (m *MockUseCase) Execute(arg0 context.Context, arg1, arg2 string) (reader.State, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Execute", arg0, arg1, arg2)
	ret0, _ := ret[0].(reader.State)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
