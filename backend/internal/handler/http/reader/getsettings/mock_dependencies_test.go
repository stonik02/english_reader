...
// Source: internal/handler/http/reader/getsettings/dependencies.go
//
// Generated by this command:
//
//	mockgen -source=internal/handler/http/reader/getsettings/dependencies.go -destination=internal/handler/http/reader/getsettings/mock_dependencies_test.go -package=getsettings
//
...
func (m *MockUseCase) Execute(arg0 context.Context, arg1 string) (reader.Settings, error) {
	m.ctrl.T.Helper()
