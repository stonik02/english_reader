...
// Source: internal/handler/http/library/upload/dependencies.go
//
// Generated by this command:
//
//	mockgen -source=internal/handler/http/library/upload/dependencies.go -destination=internal/handler/http/library/upload/mock_dependencies_test.go -package=upload
//
