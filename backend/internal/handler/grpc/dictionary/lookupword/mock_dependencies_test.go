...
// Source: internal/handler/grpc/dictionary/lookupword/dependencies.go
//
// Generated by this command:
//
//	mockgen -source=internal/handler/grpc/dictionary/lookupword/dependencies.go -destination=internal/handler/grpc/dictionary/lookupword/mock_dependencies_test.go -package=lookupword
//
...
import (
	...
	lookupword "github.com/deniskrylov/english-reader/backend/internal/usecase/dictionary/lookupword"
...
func (m *MockUseCase) Execute(arg0 context.Context, arg1 lookupword.Request) (dictionary.LookupResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Execute", arg0, arg1)
	ret0, _ := ret[0].(dictionary.LookupResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
