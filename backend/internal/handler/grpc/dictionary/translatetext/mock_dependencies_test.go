...
// Source: internal/handler/grpc/dictionary/translatetext/dependencies.go
//
// Generated by this command:
//
//	mockgen -source=internal/handler/grpc/dictionary/translatetext/dependencies.go -destination=internal/handler/grpc/dictionary/translatetext/mock_dependencies_test.go -package=translatetext
//
...
import (
	...
	translatetext "github.com/deniskrylov/english-reader/backend/internal/usecase/dictionary/translatetext"
...
func (m *MockUseCase) Execute(arg0 context.Context, arg1 translatetext.Request) (dictionary.TextTranslationResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Execute", arg0, arg1)
	ret0, _ := ret[0].(dictionary.TextTranslationResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
